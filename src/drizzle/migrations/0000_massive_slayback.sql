...
CREATE TABLE "product_customizations" (
	...
	"class_prefix" text,
	"product_id" uuid NOT NULL,
	"location_message" text DEFAULT '
        Hey! It looks like you are from <b>{country}</b>. We support Parity Purchasing Power, so if you need it, use code <b>"{coupon}"</b> to get a <b>{discount}%</b>off.' NOT NULL,
...
CREATE INDEX "products_clerk_user_id_index" ON "products" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX "user_subscriptions_clerk_user_id_index" ON "user_subscriptions" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX "user_subscriptions_stripe_customer_id_index" ON "user_subscriptions" USING btree ("stripe_customer_id");